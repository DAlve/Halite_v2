...
game = hlt.Game("Dais_v{}".format(VERSION))
logging.info("DaisBot_v{} Start".format(VERSION))

ship_plans = {}

# clear our files at the start of the game if they exist
...
while True:
    ...
    # at the start of each turn we can get some variables that are not ship dependant
    ...
    # now we can get some planet information
    ...
    # sort the planets into 3 dictionaries
    ...
    # now we need to get the data based relative to each ship
